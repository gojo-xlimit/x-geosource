...
categories = {
    "ph-routing": [".ph", "pldt", "converge", "abs-cbn", "abscbn", "gma", "rappler", "inquirer", "bdo", "bpi"],
    "multiverse-games": ["moonton", "riot", "epicgames", "steampowered", "roblox", "ea.com", "playstation", "xbox", "nintendo", "games", "gaming", "battlenet", "activision", "ubisoft", "2k", "mtg", "forgottenrealms", "ikoria", "horizons", "7daystodie"],
    ...
    "productivity-ai": ["openai", "anthropic", "notion", "canva", "chatgpt", "midjourney", "perplexity", "claude", "ai.", ".ai", "1drv", "office", "live"],
    ...
    "global-ecosystem": ["google", "microsoft", "apple", "cloudflare", "akamai", "fastly", "aws", "azure", "oracle", "ibm", "cisco", "meta", "facebook", "twitter", "instagram", "cdn"]
}
