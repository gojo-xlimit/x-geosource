...
def fetch(url, filename, exclusions=set()):
    ...
    with urllib.request.urlopen(req, timeout=30) as resp:
        for line in resp:
            ...
            # Strips Adblock syntax (||domain.com^) back to raw domain for Xray
...
# TARGET UPGRADE: HaGeZi Multi PRO (Eksaktong gamit mo sa NextDNS)
fetch("https://raw.githubusercontent.com/hagezi/dns-blocklists/main/adblock/pro.txt", "ads", bughosts)
